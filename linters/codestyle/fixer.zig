const Fixer = @This();
const source_namespace = @import("fixer_support.zig");
...
pub fn inspectFunction(self: Fixer, node: source_namespace.Ast.Node.Index) !void {
...
pub fn fixStatementIf(self: Fixer, node: source_namespace.Ast.Node.Index) !void {
...
fn wrapBranch(self: Fixer, node: source_namespace.Ast.Node.Index, closes_before_else: bool) !void {
