...
pub fn completeGitProbe(workspace: *Workspace, observation: ObservationType) bool {
...
/// ```
pub fn rename(workspace: *Workspace, name_value: []const u8) !WorkspaceRenamedType {
    ...
    return WorkspaceRenamedType.init(
