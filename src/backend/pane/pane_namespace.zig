...
pub const ParkingMutex = @import("../media/ParkingMutex.zig");
pub const GraphicsBudget = @import("../media/GraphicsBudget.zig");
pub const PaneMediaAllocator = @import("../media/PaneMediaAllocator.zig");
...
test "agent reports capture runtime geometry without accessing the observation terminal" {
    ...
    defer model_module.deinitRequest(request, std.testing.allocator);
