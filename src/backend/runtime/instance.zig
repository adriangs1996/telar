//! Runtime resource ownership, event loop, and cross-capability composition.
...
const history_runtime_mod = runtime_history.runtime;
...
const runtime_shutdown_mod = lifecycle.shutdown_coordinator;
...
test {
    ...
    _ = rename_tab_commands;
    _ = rename_tab_controller;
    _ = model_mod;
    _ = pane_mod;
    _ = workspace_mod;
    _ = attachment_mod;
