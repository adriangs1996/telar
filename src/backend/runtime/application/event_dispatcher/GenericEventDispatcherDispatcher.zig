...
pub fn Type(comptime Application: type) type {
    ...
    return struct {
        pub const EventResources = struct {
            ...
            telemetry: *source_namespace.TelemetryState,
        ...
        pub fn schedulePaneMedia(application: *Application, pane: *source_namespace.Pane) !void {
            try PaneEvents.Projection.scheduleMedia(application, pane);
        }

        pub fn schedulePaneInput(application: *Application, pane: *source_namespace.Pane) !void {
        ...
        /// ```
        pub fn handle(application: *Application, event: source_namespace.RuntimeEvent, resources: EventResources) !bool {
            switch (event) {
                .stopped => unreachable,
                .accepted => |result| {
