...
const PendingTabRenamed = delivery_mod.PendingTabRenamed;
...
pub const Controller = struct {
    ...
    /// ```
    pub fn init(responses: *ResponseQueue, rename_tab: rename_tab_commands.RenameTabExecutor) Controller {
...
const StubRenameTab = struct {
    ...
    fn executor(stub: *StubRenameTab) rename_tab_commands.RenameTabExecutor {
