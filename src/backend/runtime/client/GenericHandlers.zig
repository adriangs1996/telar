...
pub fn Type(comptime Context: type) type {
    return struct {
        ...
        agent_prompt: *const fn (*Context, @import("telar-core").AgentPrompt) anyerror!void,
        agent_interrupt: *const fn (*Context, @import("telar-core").AgentInterrupt) anyerror!void,
        agent_resume: *const fn (*Context, @import("telar-core").AgentResume) anyerror!void,
        agent_approval: *const fn (*Context, @import("telar-core").AgentApproval) anyerror!void,
        query_agent_thread: *const fn (*Context, @import("telar-core").QueryAgentThread) anyerror!void,
        query_agent_history: *const fn (*Context, @import("telar-core").QueryAgentHistory) anyerror!void,
