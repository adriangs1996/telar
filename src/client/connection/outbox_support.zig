...
pub const max_input_bytes = input_capability.max_encoded_bytes;
...
pub const OwnedHistoryQuery = @import("OwnedHistoryQuery.zig");

pub const OwnedSuggestion = @import("OwnedSuggestion.zig");

pub const OwnedSearch = @import("OwnedSearch.zig");
