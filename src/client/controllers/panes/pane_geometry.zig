...
const OfferPaneGeometryHandlerType = @import("../../application/panes/OfferPaneGeometryHandler.zig");
const OfferActivePaneGeometryHandlerType = @import("../../application/panes/OfferActivePaneGeometryHandler.zig");
const OfferEffectsType = @import("../../application/panes/OfferEffects.zig");
const ResizePaneHandlerType = @import("../../application/panes/ResizePaneHandler.zig");
const TogglePaneFullscreenHandlerType = @import("../../application/panes/TogglePaneFullscreenHandler.zig");
const PaneGeometryChangeType = @import("../../model/PaneGeometryChange.zig");
const DeliverPaneGeometryHandlerType = @import("../../application/panes/DeliverPaneGeometryHandler.zig");
...
fn bottomReservation(raw_context: *anyopaque) ?PaneBottomReservationType {
    ...
    return client.attachment_shelf.reservation();
}
