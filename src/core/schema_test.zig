...
const golden = struct {
    ...
    pub const pane_frame = "820400000000000000010000000000000000000000000000000200010001010000000000000100000000000200000012000000a1000000000020a101030201020301040078";
