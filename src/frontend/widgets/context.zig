...
palette: *const source_namespace.theme.Palette,
hovered: ?source_namespace.Action,
icon_theme: source_namespace.icons.Theme = .unicode,
icon_plan: ?*source_namespace.icons.Plan = null,

pub fn isHovered(context: *const Context, action: source_namespace.Action) bool {
