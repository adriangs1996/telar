...
const Client = struct {
    ...
    fn handleCapabilityTimeoutEvent(
        client: *Client,
        result: anyerror!void,
        host_size: schema.TerminalSize,
    ) !void {
    ...
    fn handleSentEvent(client: *Client, result: anyerror!void) !void {
        try result;
    ...
    fn handleDrawEvent(client: *Client, result: anyerror!void) !void {
        try result;
        try client.presentDue();
    }

    fn handleSidebarAnimationEvent(client: *Client, result: anyerror!void) !void {
        try result;
        client.sidebar_animation_pending = false;
    ...
    fn handleNotificationTickEvent(client: *Client, result: anyerror!void) !void {
        try result;
        client.notification_tick_pending = false;
    ...
    fn scheduleConfigReload(client: *Client, state: ConfigReloadState) !void {
