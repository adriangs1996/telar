...
pub const ApplyOutcome = union(enum) {
    stale,
    rejected,
...
/// it through the application handler. Capacity rejection keeps the previous
/// replica available until a later runtime revision arrives.
///
/// ```zig
