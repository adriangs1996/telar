...
// Borrows one sealed frame until take or destroy. No overlapping submissions.
bool telar_frame_worker_submit(telar_frame_worker *, telar_gui_viewport viewport, const telar_gui_frame *frame);
