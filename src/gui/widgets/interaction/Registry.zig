...
pub fn equivalent(left: *const Registry, right: *const Registry) bool {
    ...
    for (left.targets[0..left.len], right.targets[0..right.len]) |a, b| {
        if (!a.id.eql(b.id) or !std.meta.eql(a.bounds, b.bounds) or !std.meta.eql(a.action, b.action) or a.layer != b.layer or a.focusable != b.focusable or a.enabled != b.enabled or a.accepts_pointer != b.accepts_pointer or a.role != b.role or a.scroll_limit != b.scroll_limit or a.scroll_step != b.scroll_step or a.thread_header_offset != b.thread_header_offset or a.thread_first_key != b.thread_first_key or a.thread_last_key != b.thread_last_key or a.thread_first_offset != b.thread_first_offset or a.thread_last_offset != b.thread_last_offset or a.thread_window_revision != b.thread_window_revision or a.thread_live_revision != b.thread_live_revision or a.thread_history_generation != b.thread_history_generation or a.thread_anchor_revision != b.thread_anchor_revision or a.thread_scroll_value != b.thread_scroll_value or a.thread_resolved_scroll != b.thread_resolved_scroll or a.thread_reanchor != b.thread_reanchor or a.thread_skip_folded != b.thread_skip_folded or a.thread_prefetch != b.thread_prefetch or a.thread_has_older != b.thread_has_older or a.thread_has_newer != b.thread_has_newer or a.traverse_tab != b.traverse_tab or !std.mem.eql(u8, a.label[0..a.label_len], b.label[0..b.label_len])) {
            return false;
        }
    }
