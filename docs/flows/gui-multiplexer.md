...
Pane content clicks focus before shared mouse routing; controls consume their
own gestures. Right-clicking a tab opens its rename prompt. Sidebar scrolling and
