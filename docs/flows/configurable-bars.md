...
the interception badge. Its peach shield denotes an exact-host policy; red
denotes a suffix or global wildcard. A visible sidebar owns the complete left column, so
