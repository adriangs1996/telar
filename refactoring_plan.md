...
| BCR-12 | `request_workspace_snapshot` | `runtime/entrypoints/workspace.zig` | Workspace snapshot query controller | Pending | Query and protocol mapping are combined; focused unit tests are absent. |
