...
pub fn addInstrumentedExe(
    ...
    if (builtin.target.os.tag.isDarwin()) {
        ...
        // AFL's LLVM instrumentation when linking Zig-produced bitcode.
...
pub fn addFuzzerRun(
    ...
    if (builtin.target.os.tag.isDarwin()) {
        // Keep local fuzzing self-contained instead of requiring a system-wide
        // macOS crash reporter change. AFL++ still records observable crashes.
